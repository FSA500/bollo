    ...
    <section className="section-dark min-h-screen flex items-center pt-20 pb-16 px-6 md:px-12">
      <div className="relative z-10 max-w-[1100px] mx-auto w-full">
        ...
        <div className="max-w-2xl">
          ...
          {/* Subtext */}
          <p className="text-white/88 text-lg leading-relaxed mb-10 max-w-xl">
          ...
          <div className="grid grid-cols-3 divide-x divide-mint/20 border border-mint/20 rounded-2xl overflow-hidden bg-white/5 max-w-lg">
            <div className="px-6 py-5 text-center">
              ...
              <div className="text-white/72 text-xs mt-1 leading-tight">Google Maps<br />efter 6 mdr.</div>
            </div>
            <div className="px-6 py-5 text-center">
              <div className="font-display font-black text-mint text-2xl">3x</div>
              <div className="text-white/72 text-xs mt-1 leading-tight">Flere<br />anmeldelser</div>
            </div>
            <div className="px-6 py-5 text-center">
              <div className="font-display font-black text-mint text-2xl">24/7</div>
              <div className="text-white/72 text-xs mt-1 leading-tight">Professionelle<br />svar</div>
            </div>
          </div>

          {/* Platform logos text */}
          <p className="text-white/62 text-xs mt-6 tracking-wide uppercase">
