        ...
        <div className="max-w-2xl">
          ...
          <div className="grid grid-cols-3 divide-x divide-mint/30 border border-mint/30 rounded-2xl overflow-hidden bg-white/10 max-w-lg">
            <div className="px-6 py-5 text-center">
              ...
              <div className="text-white text-xs mt-1 leading-tight">Google Maps<br />efter 6 mdr.</div>
            </div>
            <div className="px-6 py-5 text-center">
              <div className="font-display font-black text-mint text-2xl">3x</div>
              <div className="text-white text-xs mt-1 leading-tight">Flere<br />anmeldelser</div>
            </div>
            <div className="px-6 py-5 text-center">
              <div className="font-display font-black text-mint text-2xl">24/7</div>
              <div className="text-white text-xs mt-1 leading-tight">Professionelle<br />svar</div>
            </div>
          </div>

          {/* Platform logos text */}
          <p className="text-white/80 text-xs mt-6 tracking-wide uppercase">
