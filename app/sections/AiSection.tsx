...
export default function AiSection() {
  ...
  return (
    <section ref={container} id="ai" className="section-dark py-20 px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="ai-boxes grid grid-cols-1 sm:grid-cols-2 gap-4">
            {features.map((item, i) => (
              <div
                key={i}
                className="ai-box rounded-2xl p-5 border border-mint/30 bg-white/10 transition-colors duration-300 hover:bg-white/8"
              >
